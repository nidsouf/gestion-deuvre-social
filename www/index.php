...
// ========== إحصائيات إضافية (جيزي وإجمالي الاقتطاعات) ==========
// إجمالي اقتطاعات جيزي (أرقام الهاتف النشطة)
...
// ========== آخر المحاضر (لإضافتها في لوحة التحكم) ==========
...
<div class="section">
    ...
    <div class="quick-links">
        ...
        <a href="reports/meeting_minutes.php" class="quick-link-btn"><span>📝</span> تحرير المحضر الشهري</a>
        <a href="reports/quarterly.php" class="quick-link-btn"><span>📅</span> التقرير الثلاثي</a>
    ...
    <div class="stats-grid" style="margin-bottom: 40px;">
        ...
        <!-- إضافات جديدة -->
        <div class="stat-card djezy"><span class="icon">📱</span><h3>اقتطاعات جيزي (Djezy)</h3><div class="number"><?= number_format($totalDjezy, 2) ?> <small>دج</small></div><small>شهرياً</small></div>
        <div class="stat-card total-monthly"><span class="icon">💰</span><h3>إجمالي الاقتطاعات الشهرية</h3><div class="number"><?= number_format($totalMonthlyAll, 2) ?> <small>دج</small></div><small>(عادي + جيزي)</small></div>
    </div>
        ...
        <?php if (!empty($recentMinutes)): ?>
            <div style="overflow-x:auto;">
                <table class="data-table">
                    <thead>
                        <tr><th>التاريخ</th><th>رقم الجلسة</th><th>المحتوى</th></tr>
                    </thead>
                    <tbody>
                        <?php foreach ($recentMinutes as $minute): ?>
                            <tr>
                                ...
                                <td><?= substr(htmlspecialchars($minute['content'] ?? ''), 0, 100) ?>...</span></small></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
    ...
    <div class="section">
        ...
        <div style="overflow-x:auto;">
            <table class="data-table">
                <thead>
                    <tr><th>التاريخ</th><th>النوع</th><th>الوصف</th><th style="text-align:left;">المبلغ</th></tr>
                </thead>
                <tbody>
                    <?php if (!empty($recentTransactions)): ?>
                        <?php foreach ($recentTransactions as $trans): ?>
                            <tr>
                                ...
                                <td><?= number_format((float)$trans['amount'], 2) ?> دج</span></small></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>

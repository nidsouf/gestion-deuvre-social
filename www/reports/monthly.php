...
// ========== الاقتطاعات العادية (مع استبعاد المؤجلة والمدفوعة) ==========
$sql = "SELECT 
...
// ============================================================
if ($print) {
    // تجميع البيانات للطباعة (دمج المصادر لكل موظف)
    $grouped = [];
    foreach ($all_items as $it) {
    ...
    <body>
        ...
        <table>
            <thead><tr><th>#</th><th>الموظف</th><th>المصدر</th><th>المبلغ الشهري (دج)</th></tr></thead>
            <tbody>
